...
def config():
    ...
    _a = False
    _c = {'host': '127.0.0.1', 'http_ports': [5050, 8282], 'server_ip': '127.0.0.1', 'game_port': 9933, 'server_id': 1, 'files_folder': 'Files', 'content_url': '', 'force_empty_manifest': True, 'cors_origins': ['*'], 'cors_credentials': False, 'token_ttl': 900, 'auth_ttl': 1200, 'login_ttl': 7200, 'log_level': 'info'}
